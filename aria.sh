tracker_list=$(curl -Ns https://raw.githubusercontent.com/XIU2/TrackersListCollection/master/all.txt https://ngosang.github.io/trackerslist/trackers_all_http.txt https://newtrackon.com/api/all https://raw.githubusercontent.com/hezhijie0327/Trackerslist/main/trackerslist_tracker.txt https://cdn.jsdelivr.net/gh/ngosang/trackerslist@master/trackers_best.txt https://cdn.jsdelivr.net/gh/ngosang/trackerslist@master/trackers_all.txt https://cdn.jsdelivr.net/gh/ngosang/trackerslist@master/trackers_all_udp.txt https://cdn.jsdelivr.net/gh/ngosang/trackerslist@master/trackers_all_http.txt https://cdn.jsdelivr.net/gh/ngosang/trackerslist@master/trackers_all_https.txt https://cdn.jsdelivr.net/gh/ngosang/trackerslist@master/trackers_all_ws.txt | awk '$0' | tr '\n\n' ',')
